        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 xl:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="/imobiliarias" className="text-gray-300 hover:text-white transition-colors">
                  Imobiliárias Parceiras
                </Link>
              </li>
              <li>
                <Link href="https://blog.arboimoveis.com.br/" target="_blank" className="text-gray-300 hover:text-white transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="https://superlogica.gupy.io/" target="_blank" className="text-gray-300 hover:text-white transition-colors">
                  Trabalhe conosco
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="https://plataforma.arboimoveis.com.br/produtos/crm" target="_blank" className="text-gray-300 hover:text-white transition-colors">
                  CRM imobiliário
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/financiamentoimobiliario" target="_blank" className="text-gray-300 hover:text-white transition-colors">
                  Financiamento imobiliário
                </Link>
              </li>
              <li>
                <Link href="https://plataforma.arboimoveis.com.br/#" target="_blank" className="text-gray-300 hover:text-white transition-colors">
                  ERP imobiliário
                </Link>
              </li>
              <li>
                <Link href="https://superlogica.com/imobiliarias/" target="_blank" className="text-gray-300 hover:text-white transition-colors">
                  Sistema imobiliário
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              <div className="flex items-center">
                <a href="https://api.whatsapp.com/send?phone=551140403939" target="_blank" className="flex items-center text-gray-300 hover:text-white transition-colors">
              ...
              <div>
                <Link href="https://ajuda.arboimoveis.com.br/" className="text-gray-300 hover:text-white transition-colors">
                  Central de ajuda
                </Link>
              </div>
            </div>
