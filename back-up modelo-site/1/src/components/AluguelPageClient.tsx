...
function AluguelPageContent() {
  ...
  const fetchProperties = async () => {
    try {
      const response = await fetch('/api/properties/aluguel')
      if (response.ok) {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-4">Imóveis para Aluguel</h1>
                          ...
                          <div className="flex-1 p-6">
                            ...
                            <div className="flex items-center justify-between">
                              ...
                              <Link 
                                ...
                                className="border border-orange-600 text-orange-600 px-4 py-2 rounded-lg hover:bg-orange-50 transition-colors text-sm font-medium"
                              >
                                Ver Detalhes
                              </Link>
                            </div>
                        ...
                        <div className="p-6 flex flex-col flex-1">
                          ...
                          <div className="flex flex-col gap-3">
                            ...
                            <Link 
                              ...
                              target="_blank"
                              rel="noopener noreferrer"
                              className="border border-orange-600 text-orange-600 px-4 py-2 rounded-lg hover:bg-orange-50 transition-colors text-sm font-medium text-center"
                            >
                              Ver Detalhes
                            </Link>
                          </div>
...
export default function AluguelPageClient() {
  return (
    <Suspense fallback={
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
