...
export const metadata: Metadata = {
  ...
  description: 'Encontre casas, apartamentos e coberturas para venda e aluguel. A melhor seleção de imóveis com os melhores preços.',
  openGraph: {
    title: 'Faimoveis - Imóveis para Venda e Aluguel',
          ...
          <div className="flex justify-between items-center py-3 text-sm">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex space-x-2">
                <a href={`https://wa.me/${settings.contactWhatsapp}`} target="_blank" rel="noopener noreferrer" className="w-6 h-6 bg-green-500 hover:bg-green-600 text-white rounded-full flex items-center justify-center transition-colors">
                ...
                <a href={settings.socialLinkedin} target="_blank" rel="noopener noreferrer" className="w-6 h-6 bg-blue-700 hover:bg-blue-800 text-white rounded-full flex items-center justify-center transition-colors">
                  <svg width="12" height="12" viewBox="0 0 24 24" fill="currentColor">
