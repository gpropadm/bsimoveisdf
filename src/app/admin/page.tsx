...
export default function AdminDashboard() {
  ...
  // Static data to avoid fetch errors
  const stats = {
    totalProperties: 6,
    saleProperties: 4,
    rentalProperties: 2,
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
          ...
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-blue-200 text-sm">Bem-vindo, {session.user?.name}</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <Link 
      ...
      <main className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-gradient-to-br from-blue-500/20 to-blue-600/20 backdrop-blur-md rounded-2xl p-6 border border-blue-500/30 hover:scale-105 transition-transform duration-200">
          ...
          <Link href="/admin/settings" className="group">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 group-hover:scale-105">
              <div className="text-center">
                ...
                <p className="text-gray-300">Configurar site e preferências</p>
              </div>
            </div>
          </Link>
        </div>
          ...
          <div className="p-6">
            {recentProperties.length > 0 ? (
              ...
              <div className="text-center py-8">
                <p className="text-gray-400">Nenhum imóvel cadastrado ainda</p>
              </div>
            )}
          </div>
        </div>
