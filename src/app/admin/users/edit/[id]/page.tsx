...
export default function EditUserPage({ params }: { params: { id: string } }) {
  ...
  const fetchUser = async () => {
    try {
      ...
      if (response.ok) {
        ...
        alert('Erro ao buscar usuário: ' + data.error)
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 text-lg">Carregando usuário...</p>
        </div>
      </div>
    )
  }
  ...
  if (!user) {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <p className="text-gray-600 text-lg">Usuário não encontrado</p>
        </div>
      </div>
    )
  }
      ...
      <div className="p-4 sm:ml-64">
        <div className="p-4 rounded-lg mt-14 bg-white">
              ...
              <ol className="inline-flex items-center space-x-1 md:space-x-2 rtl:space-x-reverse">
                ...
                <li aria-current="page">
                  <div className="flex items-center">
                    ...
                    <span className="ms-1 text-sm font-medium text-gray-500 md:ms-2">Editar Usuário</span>
                  </div>
                </li>
              </ol>
            </nav>
          ...
          <div className="mb-6">
            ...
            <p className="text-sm mt-1 text-gray-600">Edite as informações do usuário {user.name || user.email}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="max-w-md">
            ...
            <div className="mb-5">
              ...
              />
              <p className="mt-1 text-sm text-gray-500">Deixe em branco se não quiser alterar a senha</p>
            </div>
