...
export const metadata: Metadata = {
  title: 'Imóveis para Aluguel - Casas e Apartamentos para Alugar - ImobiNext',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="flex space-x-6">
              ...
              <Link href="/aluguel" className="text-blue-600 font-medium">Aluguel</Link>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          ...
          <p className="text-gray-600 mb-6">
            {properties.length} imóveis disponíveis para locação
          </p>
        </div>
            ...
            <Link key={property.id} href={`/imovel/${property.slug}`} className="group">
              <div className="bg-white rounded-lg shadow-sm border overflow-hidden hover:shadow-md transition-shadow">
                <div className="h-48 bg-gray-200 flex items-center justify-center relative">
                  ...
                  <div className="absolute top-3 right-3 bg-orange-600 text-white px-2 py-1 rounded text-sm font-medium">
                    Aluguel
                  </div>
                  {property.featured && (
        ...
        {properties.length === 0 && (
          <div className="text-center py-12">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 mb-2">Nenhum imóvel para aluguel encontrado</h3>
