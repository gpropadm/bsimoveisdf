...
export default function Header({ settings: propSettings }: HeaderProps) {
  ...
  // Usar configurações do hook se disponíveis, senão usar props, senão fallback
  const safeSettings = hookSettings || propSettings || {
        ...
        <div className="flex justify-between items-center py-4">
          ...
          <div className="flex items-center space-x-8">
            ...
            <Link href="/" className="flex items-center">
              ...
              <div className="flex flex-col">
                <span className="text-2xl font-bold text-black font-display leading-none">
                  {safeSettings.siteName || 'FA IMÓVEIS'}
                </span>
            ...
            <nav className="hidden lg:flex space-x-6">
              ...
              <Link href="/anunciar" className="text-gray-800 hover:text-orange-500 transition-colors">Anunciar</Link>
        ...
        {isMenuOpen && (
          <div className="lg:hidden">
            <div className="px-2 pt-2 pb-3 space-y-1 sm:px-3 border-t border-gray-200">
              ...
              <Link href="/anunciar" className="block px-3 py-2 text-base font-medium text-gray-800 hover:text-orange-500 transition-colors" onClick={() => setIsMenuOpen(false)}>Anunciar</Link>
