...
export default function SearchFormMinimalista() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4">
      <div className="bg-white/90 backdrop-blur-md rounded-lg shadow-xl p-8">
        <form onSubmit={handleSearch}>
          ...
          <button
            type="submit"
            className="w-full h-14 rounded-lg font-bold text-white text-lg transition-all duration-300 shadow-lg hover:shadow-2xl transform hover:scale-[1.02] flex items-center justify-center gap-3"
