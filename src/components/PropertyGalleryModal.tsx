  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-90 z-50 flex">
      ...
      <div className="flex-1 relative flex items-center justify-center p-4">
        ...
        <button
          onClick={nextPhoto}
          className="absolute right-96 top-1/2 transform -translate-y-1/2 text-white hover:text-gray-300 z-10"
        >
          <svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        {/* Image Counter */}
        <div className="absolute top-6 right-96 text-white bg-black bg-opacity-60 px-4 py-2 rounded-full">
          {currentPhoto + 1} / {photos.length}
        </div>

        {/* Thumbnail Strip */}
        <div className="absolute bottom-6 left-1/2 transform -translate-x-1/2 flex gap-2 max-w-2xl overflow-x-auto">
      ...
      <div className="w-80 bg-white h-full overflow-y-auto">
        <div className="p-6">
          ...
          <div className="mb-6">
            ...
            <div className={`text-2xl font-bold ${propertyType === 'venda' ? 'text-teal-500' : 'text-orange-500'}`}>
          ...
          <div>
            ...
            <div className="space-y-4">
              ...
              >
                ...
                {isSubmitting ? 'Enviando...' : 'Enviar Lead + WhatsApp'}
              </button>
            </div>
          </div>
        </div>
